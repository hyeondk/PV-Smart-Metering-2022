...
# 4.'{user_name}_dataset_day.xlsx' 파일 하나씩 불러서 weather data와 merge
def dataset_weather_merge():
    ...
    for i in range(len(user_name)):
        ...
        xlsx_name = folder_root + '\\' + f'{user_name[i]}_dataset_day.xlsx'
...
def final_merge():
    ...
    final_csv_name = df_root + '/' + 'day_merge_data.csv'
