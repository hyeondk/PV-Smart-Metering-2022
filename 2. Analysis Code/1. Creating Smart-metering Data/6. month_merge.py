### Code : 스마트미터링 자료 시, 일, 월 단위 생성 - 월 / weather data + 가구에너지패널조사 data merge
...
# 4.'{user_name}_dataset_month.xlsx' 파일 하나씩 불러서 weather data와 merge
def dataset_weather_merge():
    ...
    for i in range(len(user_name)):
        ...
        xlsx_name = folder_root + '\\' + f'{user_name[i]}_dataset_month.xlsx'
...
def final_merge():
    ...
    final_csv_name = df_root + '/' + 'month_merge_data.csv'
