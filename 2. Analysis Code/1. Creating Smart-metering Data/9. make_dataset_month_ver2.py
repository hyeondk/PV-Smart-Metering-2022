### Code : 스마트미터링 자료 시, 일, 월 단위 생성 - 월 version2
...
# 그 후, 월별로 max - min 계산 진행 -> consumption, import, production, export 모두 적용.
...
def get_value_on_use_df():
    ...
    for i in range(len(user_name)):
            ...
            if j == (len(dir_list) - 1): # j가 last index인 경우에만 아래 코드 실행
                ...
                for y in u_year:
                    ...
                    for m in u_month:
                        ...
                        before_t = day_filter2['전력 소비량(kWh)'].min()
        ...
        xlsx_name = df_root + '/' + f'{user_name[i]}_dataset_month_v2.xlsx'
