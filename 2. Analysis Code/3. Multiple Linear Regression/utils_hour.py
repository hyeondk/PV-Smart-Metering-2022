...
def pred_act_plot_hour(user):
    print(f'{user} 데이터 : MLR 시간 단위 Predicted vs Actual Scatter Plot 시작')
    # 루트 설정
    root = get_project_root()
    ...
    if idx not in [16, 31, 33, 35, 43, 45]:
        ...
        plt.suptitle(f'Scatter Plot between predicted and actual by hour for household No.{idx} site',
    ...
    fig_name = result_user_root + '/' + f'{user}_mlr_hour_predicted_actual.png'
    plt.savefig(fig_name, dpi=300, bbox_inches="tight", pad_inches=0.2)

    print(f'{user} 데이터 : MLR 시간 단위 Predicted vs Actual Scatter Plot 종료')
    return

#####################################################

# 4. Scatter Plot : X1 vs Residual
def x1_resid_plot_hour(user):
    print(f'{user} 데이터 : MLR 시간 단위 X1 vs Residuals Scatter Plot 시작')
    # 루트 설정
    root = get_project_root()
    ...
    if idx not in [16, 31, 33, 35, 43, 45]:
        sns.set(rc={'figure.figsize': (20, 24)})
        plt.suptitle(f'Scatter Plot between GHI and residuals by hour for household No.{idx} site',
                     y=0.92, fontsize=22, fontweight='bold')
    ...
    fig_name = result_user_root + '/' + f'{user}_mlr_hour_ghi_residual.png'
    plt.savefig(fig_name, dpi=300, bbox_inches="tight", pad_inches=0.2)

    print(f'{user} 데이터 : MLR 시간 단위 X1 vs Residuals Scatter Plot 종료')
    return

#####################################################

# 5. Scatter Plot : X2 vs Residual
def x2_resid_plot_hour(user):
    print(f'{user} 데이터 : MLR 시간 단위 X2 vs Residuals Scatter Plot 시작')
    # 루트 설정
    root = get_project_root()
    ...
    if idx not in [16, 31, 33, 35, 43, 45]:
        sns.set(rc={'figure.figsize': (20, 24)})
        plt.suptitle(f'Scatter Plot between Temperature and residuals by hour for household No.{idx} site',
                     y=0.92, fontsize=22, fontweight='bold')
    ...
    fig_name = result_user_root + '/' + f'{user}_mlr_hour_temp_residual.png'
    plt.savefig(fig_name, dpi=300, bbox_inches="tight", pad_inches=0.2)
...
def x3_resid_plot_hour(user):
    print(f'{user} 데이터 : MLR 시간 단위 X3 vs Residuals Scatter Plot 시작')
    # 루트 설정
    root = get_project_root()
    ...
    if idx not in [16, 31, 33, 35, 43, 45]:
        sns.set(rc={'figure.figsize': (20, 24)})
        plt.suptitle(f'Scatter Plot between Visibility and residuals by hour for household No.{idx} site',
                     y=0.92, fontsize=22, fontweight='bold')
    ...
    fig_name = result_user_root + '/' + f'{user}_mlr_hour_vis_residual.png'
    plt.savefig(fig_name, dpi=300, bbox_inches="tight", pad_inches=0.2)
